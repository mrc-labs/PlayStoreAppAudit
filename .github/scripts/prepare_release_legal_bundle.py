...
def _write_third_party_notices(
    ...
    lines.extend(
        [
            ...
            "",
            "- Store App Audit includes two static Device Specific profile data resources derived from",
            "  AuroraOSS profile material distributed with goopdl v1.2.1.",
            "- OnePlus 8 Pro EEA: `Yc.properties` -",
            "  https://github.com/Villoh/goopdl/blob/v1.2.1/goopdl/profiles/Yc.properties",
            "- Samsung Galaxy S20+: `1Z.properties` -",
            "  https://github.com/Villoh/goopdl/blob/v1.2.1/goopdl/profiles/1Z.properties",
            "- Upstream profile copyright: 2020 AuroraOSS.",
            "- Profile data license: GPL-3.0-or-later.",
            "- The modified JSON profile resources and provenance metadata are available in the",
            "  Store App Audit source tree at the exact release tag.",
            "",
