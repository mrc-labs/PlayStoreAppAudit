...
- RC1 was built and technically validated from `7c3f2e768f5a6592e12a835b40a31d70a59e0bc6`, but manual acceptance rejected it as the final candidate. RC2 technical validation has passed. Local-only RC3 Phase A is accepted, and Phase B1 is complete from Phase A checkpoint `a843c9a72e43cf24c2f069a06a0c40e13bcfa8e9`; version remains `1.99.0`, the Phase B1 Python 3.13.15 source/Qt gate is green, no RC3 package has been built and remote activity remains frozen for the separate privacy workstream.
