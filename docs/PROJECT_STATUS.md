...
- The separate Smart Queries proposal is recorded in `SMART_QUERIES_UX_REVIEW.md`. It defines the recommended model, Audit Profile boundary, fields/operators, persistence and application UX. The proposal is awaiting explicit product approval and no Smart Queries production code has been implemented.
